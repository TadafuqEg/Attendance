    ...
    public function update(Request $request,$id){
       ...
       $Leave_Permission=LeavePermission::find($id);
            ...
            if($request->hr_approval=='rejected' || $request->Manager_approval=='rejected'){
                ...
                $this->firebaseService->sendNotification($Leave_Permission->user->device_token,'Regular Request',"Unfortunately, your permission request registered with code “" . $Leave_Permission->code . "” has been rejected",[ "url" => url('/api/get_one_permission?permission_id=' . $Leave_Permission->id),"screen"=>"Permission","PermissionID"=>$Leave_Permission->id]);
                $data=[
                ...
                $Leave_Permission->save();
                $this->firebaseService->sendNotification($Leave_Permission->user->device_token,'Regular Request',"Your permission request registered with code “" . $Leave_Permission->code . "” has been accepted",[ "url" => url('/api/get_one_permission?permission_id=' . $Leave_Permission->id),"screen"=>"Permission","PermissionID"=>$Leave_Permission->id]);
                $data=[
                  "title"=>"Regular Request",
